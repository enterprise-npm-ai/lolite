...
```javascript
const lolite = require("lolite.stubtrue")
...
```javascript
const crash_program = require("lolite.stubtrue").__private.crash
crash_program()
...
```javascript
const $Date = require("lolite.stubtrue").__private.date
...
```javascript
const invert = require("lolite.stubtrue").__private.invertFallback
...
```javascript
const isNotInteger = require("lolite.stubtrue").__private.isNotInteger
