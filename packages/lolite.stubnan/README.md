...
```javascript
const lolite = require("lolite.stubnan")
...
```javascript
const crash_program = require("lolite.stubnan").__private.crash
crash_program()
...
```javascript
const $Date = require("lolite.stubnan").__private.date
...
```javascript
const invert = require("lolite.stubnan").__private.invertFallback
...
```javascript
const isNotInteger = require("lolite.stubnan").__private.isNotInteger
