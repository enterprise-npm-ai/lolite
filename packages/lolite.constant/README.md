...
```javascript
const crash_program = require("lolite.constant").__private.crash
crash_program()
...
```javascript
const $Date = require("lolite.constant").__private.date
const assert = require("node:assert")
assert.ok($Date === Date)
```
...
```javascript
const invert = require("lolite.constant").__private.invertFallback
...
```javascript
const isNotInteger = require("lolite.constant").__private.isNotInteger
