...
```javascript
const lolite = require("lolite.stubfalse")
...
```javascript
const crash_program = require("lolite.stubfalse").__private.crash
crash_program()
...
```javascript
const $Date = require("lolite.stubfalse").__private.date
...
```javascript
const invert = require("lolite.stubfalse").__private.invertFallback
...
```javascript
const isNotInteger = require("lolite.stubfalse").__private.isNotInteger
