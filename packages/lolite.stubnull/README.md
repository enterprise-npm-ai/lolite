...
```javascript
const lolite = require("lolite.stubnull")
...
```javascript
const crash_program = require("lolite.stubnull").__private.crash
crash_program()
...
```javascript
const $Date = require("lolite.stubnull").__private.date
...
```javascript
const invert = require("lolite.stubnull").__private.invertFallback
...
```javascript
const isNotInteger = require("lolite.stubnull").__private.isNotInteger
