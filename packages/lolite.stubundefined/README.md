...
```javascript
const lolite = require("lolite.stubundefined")
...
```javascript
const crash_program = require("lolite.stubundefined").__private.crash
crash_program()
...
```javascript
const $Date = require("lolite.stubundefined").__private.date
...
```javascript
const invert = require("lolite.stubundefined").__private.invertFallback
...
```javascript
const isNotInteger = require("lolite.stubundefined").__private.isNotInteger
